...
public class VentanaPrincipal extends javax.swing.JFrame {
    ...
    private void botonLineaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonLineaActionPerformed
        ...
        this.lienzo.setForma(sm.jltr.graficos.Forma.LINEA);
        System.out.println("Forma Linea " );
    }//GEN-LAST:event_botonLineaActionPerformed

    private void botonRectanguloActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonRectanguloActionPerformed
       // this.lienzo.setForma(Forma.RECTANGULO);
       this.lienzo.setForma(sm.jltr.graficos.Forma.RECTANGULO);
    ...
    private void botonOvaloActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonOvaloActionPerformed
       ...
       this.lienzo.setForma(sm.jltr.graficos.Forma.ELIPSE);
    ...
    private void botonFantasmaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonFantasmaActionPerformed
        System.out.println("Forma Fantasma");
         this.lienzo.setForma(sm.jltr.graficos.Forma.FANTASMA);
    ...
    private void botonMoverActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonMoverActionPerformed
      ...
      //this.lienzo.getatributoActual().setMover(!this.lienzo.getatributoActual().isMover());
      //this.lienzo.setMover(!this.lienzo.isMover());
      this.lienzo.getAtributosActual().setMover(!this.lienzo.getAtributosActual().isMover());
      System.out.println("Mover: " + this.lienzo.getAtributosActual().isMover() );
    ...
    private void botonColorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonColorActionPerformed
         ...
         //this.lienzo.getEstructura().getAtributos().setColor(color);
         //this.lienzo.setColorActual(color);
         this.lienzo.getAtributosActual().setColor(color);
    ...
    private void botonRellenarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonRellenarActionPerformed
       ...
       //this.lienzo.getEstructura().getAtributos().setRelleno(!this.lienzo.getEstructura().getAtributos().getRelleno());
       this.lienzo.getAtributosActual().setRelleno(!this.lienzo.getAtributosActual().getRelleno());
       //this.lienzo.setRellenoActual(!this.lienzo.isRellenoActual());
       System.out.println("Rellenar: " + this.lienzo.getAtributosActual().getRelleno() );
    ...
    private void botonTransparenciaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonTransparenciaActionPerformed
       ...
       // this.lienzo.getEstructura().getAtributos().setTransparencia(!this.lienzo.getEstructura().getAtributos().isTransparencia());
       this.lienzo.getAtributosActual().setTransparencia(!this.lienzo.getAtributosActual().isTransparencia());
       //this.lienzo.setTransparenciaActual(!this.lienzo.isTransparenciaActual());
       System.out.println("Transparencia: " + this.lienzo.getAtributosActual().isTransparencia() );
    ...
    private void botonAlisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonAlisarActionPerformed
       ...
       //this.lienzo.getEstructura().getAtributos().setAlisado(!this.lienzo.getEstructura().getAtributos().isAlisado());
       this.lienzo.getAtributosActual().setAlisado(!this.lienzo.getAtributosActual().isAlisado());
       //this.lienzo.setAlisadoActual(!this.lienzo.isAlisadoActual());
       System.out.println("Alisado: " + this.lienzo.getAtributosActual().isAlisado() );
    ...
    private void botonGrosorStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_botonGrosorStateChanged
       ...
       //this.lienzo.getEstructura().getAtributos().setStroke(st);
       this.lienzo.getAtributosActual().setStroke(st);
       //this.lienzo.setStrokeActual(st);
