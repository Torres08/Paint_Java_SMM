...
public class Lienzo extends javax.swing.JPanel {
    ...
    /**
     * Clona una instancia de BufferedImage.
     *
     * @param source La imagen BufferedImage que se va a clonar.
     * @return La imagen clonada o null si la imagen de origen es nula.
     */
    ...
    /**
     * Notifica a todos los listeners registrados que una forma ha cambiado de
     * posición.
     *
     * @param evt El evento que contiene información sobre el cambio de posición
     * de la forma.
     */
     ...
     * color.
     *
     * @param evt El evento que contiene información sobre el cambio de color de
     * la forma.
     */
    private void notifyShapeColor(LienzoEvent evt) {
        if (!lienzoEventListeners.isEmpty()) {
            for (LienzoListener listener : lienzoEventListeners) {
                listener.color(evt);
            }
    ...
    /**
     * Maneja el evento de movimiento del mouse en el formulario. Notifica a los
     * listeners registrados sobre el cambio de posición y color de la forma.
     *
     * @param evt El evento del mouse que contiene información sobre la posición
     * del mouse.
     */
    private void formMouseMoved(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_formMouseMoved
        notifyShapePosition(new LienzoEvent(this, estructura, evt.getX(), evt.getY()));
        notifyShapeColor(new LienzoEvent(this, estructura, evt.getX(), evt.getY()));
