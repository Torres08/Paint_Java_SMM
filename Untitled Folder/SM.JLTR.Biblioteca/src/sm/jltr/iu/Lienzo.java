...
public class Lienzo extends javax.swing.JPanel {
    ...
    */
    ...
    /**
    * Devuelve una nueva imagen que contiene la imagen actual con las figuras seleccionadas superpuestas.
    * Si una figura está seleccionada, se dibuja sobre la imagen y luego se elimina de la lista de figuras.
    * @return Una nueva imagen que contiene la imagen actual con las figuras seleccionadas superpuestas.
    */
    public BufferedImage getPaintedImageSeleccionada(){
        ...
        Iterator<MiForma> iterador = listaFiguras.iterator();
        while (iterador.hasNext()) {
            MiForma s = iterador.next();
            if (s.getAtributos().isSeleccionado()) {
                s.getAtributos().setSeleccionado(false);
                s.paint(g2dImagen);
                iterador.remove(); // Elimina el elemento actual de la lista
            }
        }
    ...
    */
    ...
    private void formMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_formMousePressed
        ...
        if (this.isMover()){ 
            ...
            notifyShapeAddedEvent(new LienzoEvent(this,estructura));
         ...
         if (estructura != null ){
             if (this.isMover()){
                 ...
                 if (estructura.getAtributos().isSeleccionado()){
                     notifyShapeSelectedEvent(new LienzoEvent (this,estructura));
                 }
