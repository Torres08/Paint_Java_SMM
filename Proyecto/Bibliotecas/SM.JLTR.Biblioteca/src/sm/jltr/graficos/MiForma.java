...
/**
 * Define estructura basica para las formas de mi paint. Maneja los atributos
 * comunes de dibujo
 *
 * @author torres
 */
public abstract class MiForma implements Cloneable {
    ...
    /**
     * La forma geométrica específica de esta instancia, definida por la
     * subclase.
     */
    Shape forma;
     ...
     * @return true si el punto esta contenido en la forma, false en caso
     * contrario
     */
    ...
    @Override
    public MiForma clone() {
        try {
            // Usar el método clone() de Object para realizar una copia superficial
            MiForma copia = (MiForma) super.clone();

            // Realizar una copia profunda de los atributos
            copia.atributos = this.atributos.clone(); // Suponiendo que Atributos implementa clone()
